...
%% - Plotting graph
    ...
    optimum = plot3(xopt(:,1),xopt(:,2), vpa(subs(fx,[x1,x2],xopt)),'o','MarkerSize',15,'MarkerEdgeColor','k','MarkerFaceColor',[.5 .9 1], 'DisplayName',['$\hat{x}$ = [' num2str(xopt) ']']);
    colorbar;
